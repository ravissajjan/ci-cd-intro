...
## LAB 0 — Connect your folder to GitHub
...
### 1.5 Break it on purpose — the most important step today
...
## LAB 2 — Make the pipeline stronger

### 2A. Test on more than one Node version
...
### 2B. Status badge (skip if you're running behind — it's homework T6)
...
### 2C. Branch protection — this is the important one
...
## LAB 3 — Build artifacts and publishing
...
### 3B. Secrets — never put passwords in code
...
### 3C. Docker (optional — watch the demo)
...
### 3D. Push the image to Docker Hub, automatically (do it now or finish it as homework)
